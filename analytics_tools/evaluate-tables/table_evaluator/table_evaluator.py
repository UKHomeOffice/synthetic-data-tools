...
class TableEvaluator:
    ...
    def estimator_evaluation(self, target_col: str, target_type: str = 'class') -> float:
        ...
        # self.fake_y_train = [x for x in self.fake_y_train if x is not None]
        # self.fake_y_test = [x for x in self.fake_y_test if x is not None]

        #print(self.fake_y_train)
        # print(self.fake_y_test)
